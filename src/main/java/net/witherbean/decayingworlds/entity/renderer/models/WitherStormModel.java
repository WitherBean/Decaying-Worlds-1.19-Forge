...
@OnlyIn(Dist.CLIENT)
public class WitherStormModel<T extends WitherBoss> extends HierarchicalModel<T> {
...
public static final ModelLayerLocation LAYER_LOCATION = null;
   ...
   public WitherStormModel(ModelPart p_171070_) {
      this.root = p_171070_;
