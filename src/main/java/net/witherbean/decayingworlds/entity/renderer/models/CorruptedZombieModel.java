...
// public class CorruptedZombieModel extends EntityModel<CorruptedZombie> {
// 	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("DecayingWorlds.MODID", "CorruptedZombie"), "main");
...
// 	public CorruptedZombieModel(ModelPart root) {
...
// 	@Override
// 	public void setupAnim(CorruptedZombie entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
