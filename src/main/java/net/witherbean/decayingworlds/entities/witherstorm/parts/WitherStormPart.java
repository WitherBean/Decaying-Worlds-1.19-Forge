package net.witherbean.decayingworlds.entities.witherstorm.parts;
...
public class WitherStormPart extends net.minecraftforge.entity.PartEntity<WitherStorm> {
   public final WitherStorm parentMob;
   public final String name;
   private final EntityDimensions size;

   public WitherStormPart(WitherStorm p_31014_, String p_31015_, float p_31016_, float p_31017_) {
      super(p_31014_);
