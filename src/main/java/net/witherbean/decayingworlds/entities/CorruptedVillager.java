...
public class CorruptedVillager extends Monster {

    protected CorruptedVillager(EntityType<? extends Monster> p_33002_, Level p_33003_) {
...
protected void registerGoals() {
    ...
    protected SoundEvent getAmbientSound() {
		return this.random.nextBoolean() ? SoundEventInit.CORRUPTED_VILLAGER_IDLE.get() : SoundEventInit.CORRUPTED_VILLAGER_IDLE.get();
	}

	protected SoundEvent getHurtSound(DamageSource p_35072_) {
		return SoundEventInit.CORRUPTED_VILLAGER_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return SoundEventInit.CORRUPTED_VILLAGER_DEATH.get();
	}
}