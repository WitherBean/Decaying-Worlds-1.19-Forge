...
public class CorruptedSpider extends Monster {

    protected CorruptedSpider(EntityType<? extends Monster> p_33002_, Level p_33003_) {
...
protected void registerGoals() {
    ...
    protected SoundEvent getAmbientSound() {
		return this.random.nextBoolean() ? SoundEventInit.CORRUPTED_SPIDER_IDLE.get() : SoundEventInit.CORRUPTED_SPIDER_IDLE.get();
	}

	protected SoundEvent getHurtSound(DamageSource p_35072_) {
		return SoundEventInit.CORRUPTED_SPIDER_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return SoundEventInit.CORRUPTED_SPIDER_DEATH.get();
	}
}